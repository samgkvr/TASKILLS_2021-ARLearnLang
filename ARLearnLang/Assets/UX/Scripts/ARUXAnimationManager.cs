...
public class ARUXAnimationManager : MonoBehaviour
{
    ...
    const string k_MoveDeviceText = "Медленно перемещайте устройство";
    const string k_TapToPlaceText = "Нажмите, чтобы разместить AR";
    const string k_FindABodyText = "Найдите тело для отслеживания";
    const string k_FindAFaceText = "Найдите лицо для отслеживания";
    const string k_FindClipText = "Найдите изображение для отслеживания";
    const string k_FindObjectText = "Найдите объект для отслеживания";
