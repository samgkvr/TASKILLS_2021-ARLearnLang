...
public class ARUXReasonsManager : MonoBehaviour
{
    ...
    const string k_InitRelocalText = "Инициализация дополненной реальности.";
    const string k_MotionText = "Попробуйте двигаться медленнее.";
    const string k_LightText = "Слишком темно. Попробуйте пойти в более освещенное место.";
    const string k_FeaturesText = "Ищите больше текстур или деталей в этой области.";
    const string k_UnsupportedText = "Контент AR не поддерживается.";
    const string k_NoneText = "Подождите, пока начнется отслеживание.";
